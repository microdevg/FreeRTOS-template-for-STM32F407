...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LEDA_Pin|LEDB_Pin|LEDC_Pin|LEDCD15_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LEDA_Pin LEDB_Pin LEDC_Pin LEDCD15_Pin */
  GPIO_InitStruct.Pin = LEDA_Pin|LEDB_Pin|LEDC_Pin|LEDCD15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
